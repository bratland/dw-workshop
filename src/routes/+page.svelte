		...
		<div class="max-w-5xl mx-auto">
			...
			<div class="space-y-0">
				<div class="flex gap-6 md:gap-8 pb-8 md:pb-4 border-b border-white/10">
					<div class="shrink-0 w-24 md:w-28"><span class="text-2xl font-bold">15:30</span><p class="text-white/40 text-sm md:text-xs mt-1 md:mt-0">45 min</p></div>
				...
				<div class="flex gap-6 md:gap-8 py-8 md:py-4 border-b border-white/10">
					<div class="shrink-0 w-24 md:w-28"><span class="text-2xl font-bold">16:15</span><p class="text-white/40 text-sm md:text-xs mt-1 md:mt-0">75 min</p></div>
				...
				<div class="flex gap-6 md:gap-8 py-8 md:py-4 border-b border-white/10">
					<div class="shrink-0 w-24 md:w-28"><span class="text-2xl font-bold">17:30</span><p class="text-white/40 text-sm md:text-xs mt-1 md:mt-0">15 min</p></div>
				...
				<div class="flex gap-6 md:gap-8 pt-8 md:pt-4">
					<div class="shrink-0 w-24 md:w-28"><span class="text-2xl font-bold">17:45</span><p class="text-white/40 text-sm md:text-xs mt-1 md:mt-0">15 min</p></div>
